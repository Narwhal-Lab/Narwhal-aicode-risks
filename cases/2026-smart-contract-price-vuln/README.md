# Moonwell cbETH Oracle Misconfig — $1.78M DeFi Loss (2026)
> Moonwell cbETH 预言机配置事故:AI 辅助开发链路中的金融语义校验失效

| Field | Value |
|---|---|
| Category | Domain-Specific Risks |
| Severity | 🔴 Critical |
| AI Tool | Claude Opus 4.6 (co-author), GitHub Copilot (AI review) |
| Language | Solidity |
| Real Incident | ✅ |
| Reproducible | ❌ |
| Disclosed | 2026-02-15 |
| CVE | — |
| CVSS | — |

## TL;DR
Moonwell PR #578 (Claude co-authored, Copilot-reviewed, 28 checks passed) shipped a cbETH oracle config that returned $1.12 instead of ~$2,200 — liquidators drained 1,096 cbETH, $1.78M bad debt.

> Moonwell 的 PR #578 由 Claude 共同署名、Copilot 完成 AI review、28 项检查全部通过,但 cbETH 预言机配置缺少 ETH/USD 换算,把 cbETH 价格报告为 1.12 美元(实际约 2200 美元),清算机器人瞬间夺走 1096 枚 cbETH、形成 178 万美元坏账。
