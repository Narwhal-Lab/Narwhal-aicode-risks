# Agent Hallucination Self-Propagation via Skill Files — `react-codeshift` (2026)
...
| Severity | 🟠 High |
| AI Tool | Claude Code, LLM Agent Skills |
| Language | JavaScript, YAML, Markdown |
| Real Incident | ✅ |
| Reproducible | ✅ (PoC by Aikido) |
| Disclosed | 2026-01-28 |
| CVE | — |
| CVSS | — |

## TL;DR
An LLM-hallucinated npm package `react-codeshift` was written into 47 AI-generated Agent Skill files and propagated to 237+ GitHub repos — first publicly documented agent-driven self-spreading slopsquatting.

> 大模型把虚构的 npm 包 `react-codeshift` 写进 47 份 AI 批量生成的 Agent Skill 文件,被 237+ GitHub 仓库引用,实现了从 "诱导人犯错" 到 "自动化设施自产自销错误" 的供应链投毒升级。
